...
export const metadata: Metadata = {
  title: "CSE 360 Chatbot",
  description: "An AI teaching assistant that helps CSE 360 students by providing accurate answers from past Ed Discussion posts and Course Documents.",
  openGraph: {
    title: "CSE 360 Chatbot",
    description: "An AI teaching assistant that helps CSE 360 students by providing accurate answers from past Ed Discussion posts and Course Documents.",
    type: "website",
